...
public class ManageQuizActivity extends ListActivity{
    ...
    private void showErrorAlert(String msg){
    	AlertDialog alertDialog = new AlertDialog.Builder(ManageQuizActivity.this).create();
    ...
    private class DownloadQuizzesTask extends AsyncTask<Quiz, String, List<DownloadResult>>{
    	...
    	protected void onPostExecute(List<DownloadResult> results) {
    		...
    		AlertDialog ab = new AlertDialog.Builder(ManageQuizActivity.this).create();
